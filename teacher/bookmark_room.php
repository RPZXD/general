                ...
                <div class="modal-body">
                    <form id="addBookmarkForm" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="form-check mr-3">
                                        ...
                                        <label class="form-check-label ml-2" for="laptop">แอร์</label>
                                    </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <input type="hidden" name="teach_name" value="<?php echo $userData['Teach_name'];?>">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('showBookingsBtn').addEventListener('click', function () {
        ...
        fetch('api/fetch_bookings.php?teach_id=<?php echo $teacher_id; ?>')
            .then(response => response.json())
            .then(data => {
                ...
                data.forEach((booking, index) => { // Use index from forEach
                    ...
                    row.innerHTML = `
                        ...
                        <td class="text-center"><button class="btn btn-danger btn-sm delete-booking" data-id="${booking.id}">ลบ</button></td>
                    `;
