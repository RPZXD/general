            ...
            <div class="content-header">
                <div class="container mx-auto py-4">
                    <div class="flex justify-between items-center">
                        <h1 class="text-lg font-bold">จัดการรถ</h1>
                    </div>
                </div>
            </div>
            <!-- /.content-header -->
                ...
                <div class="container mx-auto">
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-semibold">จัดการข้อมูลรถ</h3>
                                    ...
                                    <table class="display table-bordered responsive nowrap" id="record_table" style="width:100%;">
                                        <thead class="bg-indigo-500 text-white">
                                            <tr>
                                                ...
                                                <th class="px-4 py-2 border-b text-center">น้ำมัน</th>
                ...
                if (response.length === 0) {
                    ...
                    $.each(response, function(index, data) {
                        ...
                        var row = `<tr>
                            ...
                            <td class="text-center flex justify-center items-center"> <img src="${data.image_url}" class="w-[75px] h-[75px] rounded-lg"></td>
